...
export class Game {
     ...
     */
    tick(dt, keys) {
        const ptr0 = passArray8ToWasm0(keys, wasm.__wbindgen_export_0);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.game_tick(this.__wbg_ptr, dt, ptr0, len0);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('voxeldash_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
